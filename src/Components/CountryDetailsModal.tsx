...
export const CountryDetailsModal: React.FC<CountryDetailsModalProps> = ({
  ...
  return (
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-28vw h-70vh max-h-70vh flex flex-col items-center bg-white overflow-hidden border-none rounded-xl">
      {isGetCountryDetailsLoading ? (
        ...
        <>
          <h1 className="m-t-1rem ">{getCountryDetailsData?.name}</h1>
