...
export const CountryDetailsModal: React.FC<CountryDetailsModalProps> = ({
  ...
  return (
    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-28vw h-65vh max-h-65vh flex flex-col items-center bg-white overflow-hidden border-none rounded-xl">
      {isGetCountryDetailsLoading ? (
